      ...
      <div class="content">
        ...
        <div class="mt-0 mb-4">
          <v-img
            ...
            min-height="150"
            max-height="150"
            :src="imageByIndex || '/images/fish/bg0.png'"
            @click="imageByIndex = '/images/fish/bg0.png'"
...
const onHover = index => {
  imageByIndex.value = `/images/fish/${allFishes.value[index]?.split(":")[0]}.png`;
};

const onLeave = index => {
  imageByIndex.value = `/images/fish/${allFishes.value[index]?.split(":")[0]}.png`; //  '/images/fish/bg0.png'
};
