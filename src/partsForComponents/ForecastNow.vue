  ...
  <div>
    <v-card
      ...
      <div class="content">
        ...
        <!-- Image -->
        <v-img max-width="240" max-height="172" class="mx-auto mt-n8" lazy-src="/public/images/logo/1.png" :src="`/public/images/forecast/svg/${weatherCodeToIcon}.svg`" alt="forecast image">
